...
def main(client_secrets_path, scopes, port, redirect_uri):
    ...
    # code = _get_authorization_code(passthrough_val, port)
    #
...
def _get_authorization_code(passthrough_val, port):
